          ...
          <q-tab-panels v-model="tab" animated class="bg-white">
            <q-tab-panel name="all" class="q-pa-none full-height" :style="{'height':size['height']-80+'px !important'}">
              <q-list class="">
                ...
                <q-item-label header class="text-center">{{contacts_list.length}} {{ $t('pages.contact.contacts') }}</q-item-label>
            ...
            <q-tab-panel name="favorites" class="q-pa-none" :style="{'height':size['height']-80+'px !important'}">
              <q-list class="">
                ...
                <q-item-label header class="text-center">{{favorites_list.length}} {{ $t('pages.contact.fav') }}</q-item-label>
        ...
        <q-card class="no-border no-border" :style="{'height':size['height']-24+'px !important'}">
          ...
          <q-item clickable v-ripple>
            ...
            <q-item-section>
              ...
              <q-item-label caption class="text-grey-8">{{ $t('pages.contact.phone') }}</q-item-label>
            </q-item-section>
          ...
          <q-item clickable v-ripple>
            ...
            <q-item-section>
              ...
              <q-item-label caption class="text-grey-8"> {{ $t('pages.contact.secondary_phone') }} </q-item-label>
            </q-item-section>
          ...
          <q-item clickable v-ripple>
            ...
            <q-item-section>
              ...
              <q-item-label caption class="text-grey-8"> {{ $t('pages.contact.email') }}</q-item-label>
            </q-item-section>
          ...
          <q-item clickable v-ripple>
            ...
            <q-item-section>
              ...
              <q-item-label caption class="text-grey-8">{{ $t('pages.contact.company_email') }}</q-item-label>
            </q-item-section>
          ...
          <q-item clickable v-ripple>
            ...
            <q-item-section>
              ...
              <q-item-label caption class="text-grey-8"> {{ $t('pages.contact.address') }} </q-item-label>
            </q-item-section>
          ...
          <q-item clickable v-ripple>
            ...
            <q-item-section>
              ...
              <q-item-label caption class="text-grey-8">{{ $t('pages.contact.website') }}</q-item-label>
            </q-item-section>
