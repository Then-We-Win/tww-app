      ...
      sales_data: [
        {
            ...
            total: '303,344',
            code: 'KDH8WK',
            prod_img: require('src/statics/bag.jpg')
        ...
        },
        {
            ...
            total: '23,100',
            code: 'AA43OX',
            prod_img: require('src/statics/laptop.jpg')
        },
        {
            name: 'Mayur Patel',
            Progress: 30,
            ...
            date: '19 Sept 2020',
            code: 'J2K9QQ',
            prod_img: require('src/statics/jam.jpg')
        },
        {
            name: 'Jeff Galbraith',
            Progress: 100,
            ...
            date: '19 Sept 2020',
            code: 'JKL345',
            prod_img: require('src/statics/action.jpg')
        }
    ],
    sales_column: [
        {
